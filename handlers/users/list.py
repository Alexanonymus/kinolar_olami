...
async def al(msg: types.Message, state: FSMContext):
    ...
    if obj.page(page).has_other_pages():
        await msg.answer(f"{f}\nBizning ijtimoiy tarmoqlar:\n<a href='https://t.me/englishfilmwithsub'>Telegram</a>  |  <a href='https://www.youtube.com/channel/UCtHZPqD5u4MlzPRABEuFtjw'>YouTube</a>", parse_mode='html', reply_markup=next2, disable_web_page_preview=True)
    else:
        await msg.answer(f"{f}\nBizning ijtimoiy tarmoqlar:\n<a href='https://t.me/englishfilmwithsub'>Telegram</a>  |  <a href='https://www.youtube.com/channel/UCtHZPqD5u4MlzPRABEuFtjw'>YouTube</a>", parse_mode='html', disable_web_page_preview=True)
