    ...
    if len(message.text) >= 4:
        try:
            ...
            for film in films:
                try:    
                    if film[1] == None:
                        await message.answer_photo(film[2], caption=f"<a href='{film[3]}'>{film[0]}</a>\n\nBizning ijtimoiy tarmoqlar:\n<a href='https://t.me/englishfilmwithsub'>Telegram</a>  |  <a href='https://www.youtube.com/channel/UCtHZPqD5u4MlzPRABEuFtjw'>YouTube</a>")
                    else:
                        await message.answer_photo(film[2], caption=f"<a href='{film[3]}'>{film[0]}</a>\n\n {film[1]}\n\nBizning ijtimoiy tarmoqlar:\n<a href='https://t.me/englishfilmwithsub'>Telegram</a>  |  <a href='https://www.youtube.com/channel/UCtHZPqD5u4MlzPRABEuFtjw'>YouTube</a>")
                except:
                    if film[1] == None:
                        await message.answer(f"<a href='{film[3]}'>{film[0]}</a>\n\nBizning ijtimoiy tarmoqlar:\n<a href='https://t.me/englishfilmwithsub'>Telegram</a>  |  <a href='https://www.youtube.com/channel/UCtHZPqD5u4MlzPRABEuFtjw'>YouTube</a>", disable_web_page_preview=True)
                    else:
                        await message.answer(f"<a href='{film[3]}'>{film[0]}</a>\n\n {film[1]}\n\nBizning ijtimoiy tarmoqlar:\n<a href='https://t.me/englishfilmwithsub'>Telegram</a>  |  <a href='https://www.youtube.com/channel/UCtHZPqD5u4MlzPRABEuFtjw'>YouTube</a>", disable_web_page_preview=True)
            if len(films) == 0:
